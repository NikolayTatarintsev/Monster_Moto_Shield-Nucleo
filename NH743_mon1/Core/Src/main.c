...
/**
  ...
  *
  ******************************************************************************
  Программа управления электродвигателем (мотором) постоянного тока.
  Используемое оборудование:
  1. NUCLEO-H743ZI2 (верс. NUH743ZI$AT1, MB1364C, MB1364-H743ZI-C01 F192404187)
  с  микроконтроллером STM743ZIT6U;
  2. MonsterMoto-Shield на базе VNH2SP3;
  3. Электродвигатель (мотор) постоянного тока;

  Среда разработки STM32CubeIDE v. 1.14.0
  Татаринцев Н.И, 01.05.2024 г.
